...
(define (cond-clauses exp) (rest-exps exp))
(define (cond-else-clause? clause)
  (eq? (cond-predicate clause) 'else))
(define (cond-predicate clause) (first-exp clause))
(define (cond-actions clause) (rest-exps clause))
(define (cond->if exp)
...
(define (extend-environment vars vals base-env)
  (if (= (length vars) (length vals))
      ...
      (if (< (length vars) (length vals))
          (error "Too much arguments" vars vals)
          (error "Not enough arguments" vars vals))))
